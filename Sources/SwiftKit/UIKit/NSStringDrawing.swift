...
// MARK: ExtendedStringDrawing Bridge
...
extension String {
  ...
  public func sizeThatFits(_ size: CGSize, options: NSStringDrawingOptions = [.usesFontLeading, .usesLineFragmentOrigin], font: UIFont) -> CGSize {
    return sizeThatFits(size, options: options, attributes: [.font: font])
  }
  ...
  public func heightThatFits(width: CGFloat, options: NSStringDrawingOptions = [.usesFontLeading, .usesLineFragmentOrigin], font: UIFont) -> CGFloat {
    return heightThatFits(width: width, options: options, attributes: [.font: font])
  }
...
extension NSAttributedString {
  ...
  final public func sizeThatFits(_ size: CGSize, options: NSStringDrawingOptions = [.usesFontLeading, .usesLineFragmentOrigin]) -> CGSize {
    return boundingRect(with: size, options: options, context: nil).size
  }
  
  final public func heightThatFits(width: CGFloat, options: NSStringDrawingOptions = [.usesFontLeading, .usesLineFragmentOrigin]) -> CGFloat {
