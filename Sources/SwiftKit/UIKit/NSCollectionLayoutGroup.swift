...
@available(iOS 13.0, *)
@_marker public protocol _NSCollectionLayoutGroupProtocol {
}

@available(iOS 13.0, *)
extension NSCollectionLayoutGroup: _NSCollectionLayoutGroupProtocol {
}
...
@available(iOS 13.0, *)
extension _NSCollectionLayoutGroupProtocol where Self: NSCollectionLayoutGroup {

  /// if `layoutSize` is nil, width and height dimensions of  any`subitems` must not be fractional.
  public init(layoutSize: NSCollectionLayoutSize? = nil, subitems: [NSCollectionLayoutItem], layoutDirection: CollectionLayoutDirection, interItemSpacing: CGFloat = 0) {
  ...
  public init(layoutSize: NSCollectionLayoutSize? = nil, repeating repeatedSubitem: NSCollectionLayoutItem, count: Int, layoutDirection: CollectionLayoutDirection, interItemSpacing: CGFloat = 0) {
    switch layoutDirection {
    case .horizontal:
      let layoutSize = layoutSize ?? {
        let layoutWidth: NSCollectionLayoutDimension
        let layoutItemWidth = repeatedSubitem.layoutSize.widthDimension
        if layoutItemWidth.isAbsolute {
    ...
    case .vertical:
      let layoutSize = layoutSize ?? {
        ...
        if layoutItemHeight.isAbsolute {
