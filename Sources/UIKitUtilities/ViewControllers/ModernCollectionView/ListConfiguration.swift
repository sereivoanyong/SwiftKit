...
public struct ListConfiguration {
  ...
  public let content: UIContentConfiguration?
  public let background: UIBackgroundConfiguration?
...
public struct ListSection<ID: Hashable>: Identifiable {
  ...
  public let id: ID
  public let headerConfiguration: ListConfiguration?
  public let footerConfiguration: ListConfiguration?
