...
@available(iOS 15.0, *)
open class CollectionViewDiffableListDataSource<Section: Identifiable & Sendable, Item: Identifiable & Sendable>: UICollectionViewDiffableDataSource<Section.ID, Item.ID> where Section.ID: Hashable & Sendable, Item.ID: Hashable & Sendable {
